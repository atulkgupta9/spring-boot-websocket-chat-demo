...
public class SyncBulkTransfer
{
    ...
    private static final short VENDOR_ID = 0x413c;

    /** The vendor ID of the Samsung Galaxy Nexus. */
    private static final short PRODUCT_ID = 0x2107;
...
//        getByte(handle,buffer,transferred);
...
//        write(handle, CONNECT_BODY);
    ...
    public static byte getByte(DeviceHandle handle, ByteBuffer  buffer, IntBuffer transferred){
        for(byte i=0; i<128; i++){
            if( LibUsb.bulkTransfer(handle, IN_ENDPOINT, buffer,
